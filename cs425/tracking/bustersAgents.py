...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        #     beliefs.append(belief.argMax())
        #
        # goalPos = None
        # goalProb = 0
        # for i, pos in enumerate(beliefs):
        #     if livingGhostPositionDistributions[i][pos] >= goalProb:
        #         goalPos = pos
        #         goalProb = livingGhostPositionDistributions[i][pos]
        #
        # tmp = []
        # for action in legal:
        #     nextPos = Actions.getSuccessor(pacmanPosition, action)
        #     tmp.append((self.distancer.getDistance(nextPos, goalPos), action))
        #
        # return min(tmp)[1]
